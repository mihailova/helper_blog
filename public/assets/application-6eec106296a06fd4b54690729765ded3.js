...
(function() {
  var num_of_pics, upload_template;

  num_of_pics = 0;

  $(function() {
    return $('.post textarea').wysihtml5({
      'font-styles': true,
      emphasis: true,
      lists: true,
      html: true,
  ...
  $(function() {
    return $("#add-picture").click(function(e) {
      e.preventDefault();
  ...
  upload_template = function(index) {
    return '<input id="post_pictures_' + index + '" name="post[pictures_attributes][' + index + '][image]" type="file">' + '<div class="input string optional"><label class="string optional" for="post_pictures_attributes_' + index + '_caption"> Caption</label>' + '<input class="string optional" id="post_pictures_attributes_' + index + '_caption" maxlength="255" name="post[pictures_attributes][' + index + '][caption]" size="50" type="text"></div>';
  };
